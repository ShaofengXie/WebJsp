...
public class Employee implements Serializable {
	...
	// 员工国籍
	@Column(name = "emp_nation", nullable = false, length = 50, unique = true)
	...
	// 初始化全部成员变量的构造器
	public Employee(Integer id, String name, String pass, double salary,String nation,Integer age, Manager manager, Set<Attend> attends,
